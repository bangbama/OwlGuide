...
#ifndef OWLGUIDE_SWIFT_H
#define OWLGUIDE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OwlGuide",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8OwlGuide11AppDelegate")
...
@class NSCoder;
@class NSWindow;
SWIFT_CLASS("_TtC8OwlGuide23FloatingPanelController")
@interface FloatingPanelController : NSWindowController <NSWindowDelegate>
...
SWIFT_CLASS("_TtC8OwlGuide25InspectorWindowController")
